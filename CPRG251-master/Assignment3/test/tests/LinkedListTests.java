...
class LinkedListTests {
    ...
    /**
     * Tests entering different data types to the linked list
     */
    @Test
    void testInsertDataTypes() {
        this.linkedList.append("a");
        this.linkedList.append(2);
        this.linkedList.append(true);
        this.linkedList.append(57.9);

        //test that the linked list is not empty
        assertFalse(this.linkedList.isEmpty());
        ...
        assertEquals(true, this.linkedList.retrieve(2));
        assertEquals(57.9, this.linkedList.retrieve(3));
    }
    /**
    ...
    /**
     * Tests finding a node that doesn't exist in the list
     */
    @Test
